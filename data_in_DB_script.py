...
def store_data(Patent_ID, Title, Description):
	...
	try:
	    ...
	    cnx.commit()
	    print("Commited to DB Patent: ",Patent_ID )
	    return
...
""" Loading json files """
origin_directory = "/Users/Salar_Hajimirsadeghi/Google Drive/Projects/Patents/Data/json_files"
os.chdir(origin_directory)
for json_file in os.listdir(origin_directory):
